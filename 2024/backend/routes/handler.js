...
router.get('/api/FKJDKLFJLAKDJFLKAJDKFLAJDKFA', async (req, res) => {
...
router.get('/api/kjlfdsakljLFKJADKLFJAKLJDAk2938192', async (req, res) => {
...
router.post('/sendMessage', async (req, res) => {
    ...
    const BGColor = req.body.cardBackgroundColor || "rgb(0, 0, 0)";
