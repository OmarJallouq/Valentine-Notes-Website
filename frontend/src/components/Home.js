    ...
    return(
        <section>
            ...
            <div style={{width: '100%', height: '100%', position: 'relative', top: '280px'}}>
                ...
                <div style={{width: 360, height: 294, left: 34, top: 20, position: 'absolute', color: 'black', fontSize: 24, fontFamily: 'Itim', fontWeight: '400', wordWrap: 'break-word', backgroundColor: 'transparent'}}>Want to send someone a message? Maybe even annonymously? Now's your chance! Press Send a Message to send a letter to that special someone, or press Inbox to view the letters from your admirers!</div>
