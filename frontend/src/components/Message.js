            ...
            <form id="messagesForm" method="POST" action="/api/sendMessage">
                <div class="submit_wrapper">
                    ...
                    <input type="hidden" id="cardBackgroundColor" name="cardBackgroundColor" value={cardBackgroundColor} />
                        ...
                        <textarea class="messageTA submit_lightScheme__lLwOA" name="messageInput" maxLength="67" placeholder="Type Your Message Here..." style={{fontSize: '44px', lineHeight: '52px'}} onChange={handleTextAreaChange}></textarea>
                        <div class="sender_div" style={{background: 'transparent'}}>
                            ...
                            <input class="sender_name" name="senderInput" maxLength="16" placeholder="Enter Name" style={{fontSize: '33px', lineHeight: '44px', paddingLeft: '6px'}}/>
                        </div>
                    </div>
